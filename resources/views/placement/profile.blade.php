                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                      ...
                      <form id='upload-form1' action="{{ url('/placement/profile') }}" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">{{ csrf_field() }}
