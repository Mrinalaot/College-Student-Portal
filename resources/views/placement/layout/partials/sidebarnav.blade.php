<div class="col-md-3 left_col">
    <div class="left_col scroll-view">
        ...
        <div class="navbar nav_title" style="border: 0;">
            <a href="index.html" class="site_title">Placement Dahboard</a>
        </div>
                ...
                <ul class="nav side-menu">
                    <li><a ><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="{{asset('/placement')}}">placement Home</a></li>
                            <li><a href="{{asset('/placement/profile')}}">Update Profile</a></li>
                            <li><a href="{{asset('/placement/change_password')}}">Change Password</a></li>
                        </ul>
                    </li>
