                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                      ...
                      <form id='upload-form1' action="{{asset('/exam/profile')}}" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">{{ csrf_field() }}
                    ...
                    <span class="input-group-btn">
                      ...
                      <div class="profile_title">
                          ...
                          <div class="col-md-6">
                          <form name="form1" action="{{asset('/exam/profile')}}" method="POST"  class="form-horizontal form-label-left input_mask">{{ csrf_field() }}
