                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                      ...
                      <form id='upload-form1' action="{{ url('/student/profile') }}" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">{{ csrf_field() }}
                    ...
                    <span class="input-group-btn">
                      ...
                      <div class="profile_title">
                          ...
                          <div class="col-md-6">
                            ...
                            <input id="user_name" type="text" class="form-control has-feedback-left" name="user_name" placeholder="First Name" value="{{ Auth::user()->user_name}}" required> 
