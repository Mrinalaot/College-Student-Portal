                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <td colspan="2">
                                                            <select name="is_lateral" id="is_lateral"  class="form-control" required>
...
<!--Form is here -->                         
                            <div id="step-5">
                                <form class="" id="form5" action="{{ url('/student/form_submit_5') }}" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                    <fieldset id="f5">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover">
